# Lesson 15: コストを下げるために、ここの部品を変えました (Kosuto o Sageru Tame ni, Koko no Buhin o Kaemashita)
...
🎧 **Audio:**  
[Listen to this lesson](../mp3/skit15.mp3)
...
**Usage examples:**
- ちょっと時間をください - Can you give me just a minute?
- ちょっと手伝ってもらいたいんだけど - I'd like a little help with something
- ちょっといいですか - Do you have a moment?
...
**Usage examples:**
- コストを下げる - reduce costs
- コスト削減（さくげん）- cost reduction
- 低（てい）コスト - low cost
- コスト管理（かんり）- cost management
...
- Keeping team members informed of progress
- Allowing supervisors to track project status
...
- Reporting changes to designs or plans
- Explaining cost-reduction measures
- Justifying modifications to procedures
...
**Examples:**
- コストを下げるために - in order to reduce costs
- 品質を上げるために - in order to improve quality
- 時間短縮のために - for the purpose of time reduction

**Past tense usage:**
When explaining results of past actions, use past tense before ために:
- 部品を変えたために、大きくなりました - Because we changed the part, it became larger
...
**Formation:**
[Verb plain form] + ようですね  
[い-adjective] + ようですね  
[な-adjective] + な + ようですね

**Examples:**
- 大きくなったようですね - It looks like it got bigger
- 問題ないようですね - It seems there's no problem
- 便利なようですね - It appears to be convenient
...
**Examples:**
- 特にありません - Not particularly / None in particular
- 特に問題ありません - No particular problem
- 特に質問ありません - No questions in particular
...
**Compounds:**
- 変更「へんこう」- henkō - change, alteration
- 大変「たいへん」- taihen - terrible, very, difficult
- 変える「かえる」- kaeru - to change (transitive)
