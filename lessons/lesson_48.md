# Lesson #48: 今日明日中には (Kyoo ashita juu niwa)
...
- ❌「できません」(I can't) - too direct
- ✓「難しいです」(It's difficult) - softer
- ✓「ちょっと…」(A bit...) - implies difficulty
- ✓「検討させてください」(Let me consider) - buys time
...
- [verb]できず、申し訳ございません。  
  (I apologize for not being able to [verb].)
...
**Examples:**
- お調べしましたところ  
  (after checking / when I investigated)
  
- お聞きしましたところ  
  (after asking / when I inquired)
  
- 確認しましたところ  
  (after confirming / when I verified)
...
**Different uses:**
- 今週中に (within this week) - deadline
- 今週中は (during this week) - timespan
- 今日明日中には (within today or tomorrow) - urgent deadline

**Examples:**
- 今日中に終わります。  
  (I'll finish within today.)
  
- 一週間中に返事します。  
  (I'll reply within a week.)
  
- 営業時間中は対応できます。  
  (We can handle it during business hours.)
...
**Usage:**
When someone thanks or apologizes to you, and you want to say "I'm the one who should thank/apologize":

- Customer: ありがとうございます。  
  You: いえ、こちらこそ。(No, thank YOU.)

- Superior: 助かったよ。  
  You: いえ、こちらこそ勉強になりました。(No, I'm the one who learned.)
...
**Related expressions:**
- お手数をおかけする (to cause you trouble/extra work)
- ご心配をおかけする (to cause you worry)
- ご面倒をおかけする (to cause you bother)
...
**Usage:**
- 無理しないでください。(Don't overdo it.)
- 無理なお願い (unreasonable request)
- 無理やり (forcibly, by force)
...
- すぐにお答えできず、申し訳ございませんでした。  
  (I apologize for not being able to answer immediately.)

### Following up after checking

- お調べしましたところ、～とのことです。  
  (After checking, it seems that~)
...
- 申し訳ございません。～が入っておりまして、～は難しいです。  
  (I apologize. We have ~ scheduled, so ~ is difficult.)

### Offering alternatives

- ～は無理なんですが、～であればお受けできます。  
  (~ is impossible, but if it's ~, we can accept it.)
...
- Study more advanced keego patterns
- Learn industry-specific terminology for your field
- Observe how native speakers handle various situations
