...
ワンさん、このあと１番テーブルはデザートになりますけど、できていますか。  
...
- Team cooperation during rush times
...
**Examples:**
- 今、手が離せないので、後で電話します。  
  (I can't talk now, so I'll call you back later.)
  
- 手が離せない時は、誰かに頼んでください。  
  (When I'm tied up, please ask someone else.)
