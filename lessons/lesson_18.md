# Lesson 18: お気持ちはありがたいのですが、受け取らない決まりになっております (Okimochi wa Arigatai no desu ga, Uketora nai Kimari ni Natte Orimasu)

## Declining Gifts Politely

**English Title:** Explaining rules politely when refusing gifts

🎧 **Audio:** [Listen to this lesson](../mp3/skit18.mp3)
...
> **Explanation:**  
> This phrase is essential for politely declining gifts while maintaining good relationships:
> 1.「お気持ちはありがたい」- "Your sentiment is appreciated" (acknowledges their kindness)
> 2.「のですが」- "but..." (polite contrasting connector)
> 3.「受け取らない決まりになっております」- "it's a rule not to accept" (explains it's policy, not personal)
> 
...
**Usage examples:**
- 面会時間（じかん）- meeting time
- 面会の約束（やくそく）- a scheduled meeting
- 社長（しゃちょう）に面会を申し込む - ask for a meeting with the company president
- 来客（らいきゃく）と面会する - meet with clients
...
**Usage examples:**
- 決まりを守る（まもる）- follow a rule
- 決まりを決める - make a rule
- 施設内（しせつない）の決まり - facility rules
- 利用（りよう）の決まり - rules of use
- 決まりのある生活（せいかつ）をする - keep a disciplined lifestyle
...
- After traveling (bringing back souvenirs)
- To show gratitude to those who help you
- In business relationships

However, many workplaces, especially hospitals and care facilities, have strict no-gift policies to:
- Prevent any appearance of favoritism
- Maintain professional boundaries
- Avoid placing staff in awkward positions
- Ensure equal treatment for all patients/clients
...
- Describe established procedures
- Make statements sound official yet polite
- Remove personal responsibility from the speaker
...
**Formation:**
[Plain form/Polite form] + っけ

**Examples:**
- 何時まででしたっけ - What time was it until again?
- どこでしたっけ - Where was it again?
- いくらでしたっけ - How much was it again?
...
**Formation:**
[Verb plain form] + ことになっております  
[Time/State] + になっております

**Examples:**
- 7時30分までになっております - It's (set as a rule) until 7:30
- 受け取らない決まりになっております - It's a rule not to accept
- 禁煙になっております - It's (designated as) non-smoking
...
**Examples:**
- ルールだから仕方ない - It's a rule, so it can't be helped
- 雨だから仕方ない - It's raining, so there's nothing we can do
...
### Honorific forms (尊敬語):
- 食べる → 召し上がる (meshiagaru) - to eat (honorific)
- いる → いらっしゃる (irassharu) - to be (honorific)

### Humble forms (謙譲語):
- もらう → 頂く (itadaku) - to receive (humble)
- する → いたす (itasu) - to do (humble)
- いる → おる (oru) - to be (humble) in おります
...
- 即決「そっけつ」- sokketsu - prompt decision
- 決まる「きまる」- kimaru - to be decided (intransitive)
- 決める「きめる」- kimeru - to decide (transitive)
- 決まり「きまり」- kimari - rule, regulation
