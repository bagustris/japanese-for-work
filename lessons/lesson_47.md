# Lesson #47: では、手短に申し上げます (Dewa, temijika ni mooshiagemasu)
...
🎧 **Audio:**  
[Listen to this lesson](../mp3/skit47.mp3)
...
- Humbles your own action of speaking
- Standard in business communication with superiors
...
**Examples:**
- 今日中に  
  (within today / by the end of today)
  
- 今週中に  
  (within this week / by the end of this week)
  
- 今月中に  
  (within this month / by the end of this month)
  
- 5時中に  
  (by 5 o'clock)

**Note:** Without「に」,「中」means "during" rather than "by":
- 今日中 (kyoojuu) - during today / within today
...
**Examples:**
- 確認のために説明してください。  
  (Please explain for confirmation.)
...
**Similar patterns:**
- お疲れのところ (when someone is tired)
- お休みのところ (when someone is resting)
...
**Usage:**
- Used for documents, reports, emails
- Implies a thorough but relatively quick review
- Less formal than「確認する」or「チェックする」

**Examples:**
- メールに目を通してください。  
  (Please look over the email.)
...
- 書き終わる (kaki-owaru) - to finish writing
- 食べ終わる (tabe-owaru) - to finish eating
- 使い終わる (tsukai-owaru) - to finish using
...
- 確認のために説明してもらえますか。  
  (Could you explain it back for confirmation?)
