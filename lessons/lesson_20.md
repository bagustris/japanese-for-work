# Lesson 20: 場合によっては間に合わないこともあります (Baai ni Yotte wa Maniawanai Koto mo Arimasu)
...
> **Explanation:**  
> This phrase is crucial for managing expectations honestly and professionally:
> 1.「場合によっては」- "depending on the situation" (acknowledges variables)
> 2.「間に合わないこともあります」- "there are cases where we won't make it" (honest possibility)
> 3.「よろしいでしょうか」- "is that acceptable?" (asks for understanding)
> 
...
**Usage examples:**
- 出発する前に、道路事情をよく調べておいたほうがいいですよ。  
  It's a good idea to check traffic conditions before leaving the house.
- 就活事情 - The job-hunting situation
- 諸事情 - Various circumstances
- 住宅事情 - The housing situation
...
**Usage examples:**
- (職場のポスター) 安全第一、声かけ、確認を徹底しましょう。  
  (On a workplace poster) Safety first, reach out to others, and check thoroughly.
- 安全第一で今日も一日がんばろう。  
  Let's do our best today with "safety first" in mind.
...
- Saying「大丈夫です」creates a promise or guarantee
- If you can't fulfill it, customers will feel deceived
- It's better to be honest about uncertainty than overpromise
- Use phrases like「場合によっては」to acknowledge variables
...
- Never rush at the expense of safety
- Following safety protocols is more important than speed
- Using「安全第一」shows responsibility
- Customers generally accept safety as a valid reason for delays
...
**Formation:**
場合によっては + [possible outcome]

**Examples:**
- 場合によっては間に合わない - Depending on the situation, we might not make it
- 場合によっては延期します - Depending on circumstances, we'll postpone
- 場合によっては中止になる - It may be cancelled depending on the situation
...
**Formation:**
[Noun] + によって + [outcome that varies]

**Examples:**
- 道路事情によって変わります - It varies according to traffic conditions
- 人によって意見が違う - Opinions differ depending on the person
- 天気によって決めます - We'll decide based on the weather
...
**Formation:**
[Verb plain form] + こともあります

**Examples:**
- 間に合わないこともあります - There are times when we don't make it
- 遅れることもあります - Sometimes it's delayed
- 変更になることもあります - There are cases when it changes
...
- かしこまりました (service industry, highest formality)
...
**Examples:**
- 乗りたいんです - (The thing is,) I want to catch it
- 急いでいるんです - (The thing is,) I'm in a hurry
- 予約したんです - (The thing is,) I made a reservation
...
**Standard → Humble:**
- 待つ → お待ちする (omachi suru) - to wait
- 預かる → お預かりする (oazukari suru) - to hold, keep
- 調べる → お調べする (oshirabe suru) - to check
- 閉める → お閉めする (oshime suru) - to close

**Formula for humble forms:**
お + [verb stem] + する/いたす
...
- 起業「きぎょう」- kigyō - starting a business, entrepreneurship
- 起きる「おきる」- okiru - to wake up, to get up, to occur
