...
🎧 **Audio:** [Listen to this lesson](../mp3/skit13.mp3)
...
- 電話帳 - denwachō - phone book or directory
- 電話機能 - denwa kinō - telephone function
- 電話料金 - denwa ryōkin - telephone bill
...
**Usage examples:**
- 「山田が席に戻りましたら、折り返し電話をさせますので、少々お待ちいただけますか」  
  When Yamada returns to his desk, I'll have him call you back.
- 「山本さんがお戻りになったら、折り返しお電話いただけますか」  
  When Yamamoto-san returns, could you please have her call me back?
...
- It literally means "We are in your care" or "Thank you for your continued support"
- It's used even if you've never personally worked with the person
- The response is usually the same phrase, creating a mutual acknowledgment
- Shows recognition of the ongoing business relationship

### Dropping Honorifics for Internal Staff

When talking to outsiders about your own company members:
- Say「和田」not「和田さん」
- Use humble forms like「外出しております」
- This shows modesty about your in-group
- It's considered inappropriate to use respectful language for your own colleagues when talking to clients
...
**Examples:**
- 電話に出ております - He is on the phone (speaking about your colleague)
- 外出しております - He is out of the office
- お待ちしております - We are waiting (humble)
...
**Examples:**
- 戻る → お戻りになる - to return (respectful)
- 使う → お使いになる - to use (respectful)
- 帰る → お帰りになる - to go home (respectful)
...
**Usage:**
- 田中さんはいらっしゃいますか。 - Is Tanaka-san there?
- いらっしゃいますでしょうか。 - More polite version

### 4. Causative + ましょうか - Offering to have someone do something

**Formation:**
[Verb causative form] + ましょうか

**Examples:**
- 電話させましょうか - Shall I have (him) call?
- 確認させましょうか - Shall I have (him) check?
- 説明させましょうか - Shall I have (him) explain?
...
### Humble Forms (謙譲語)
- 言う (iu) → 申す (mōsu) → 「金子と申します」
- いる (iru) → おる (oru) → 「出ております」
- 待つ (matsu) → お待ちする (omachi-suru)

### Respectful Forms (尊敬語)
- いる (iru) → いらっしゃる (irassharu)
- 戻る (modoru) → お戻りになる (omodori ni naru)
- 来る (kuru) → おいでになる (oide ni naru)

### Polite Forms (丁寧語)
- です/ます forms throughout
- でしょうか instead of ですか for extra politeness
