# Lesson 12: いま急ぎでお客様の資料をまとめているところなんだ (Ima Isogi de Okyaku-sama no Shiryō o Matomete Iru Tokoro nan da)
...
**Usage examples:**
- 急ぎの案件 - isogi no anken - A rush job / urgent matter
- 急ぎの仕事があるから明日は残業になる - I have an urgent task to work on, so I will do overtime tomorrow.
- コピーを急ぎで10部お願いします。 - I need 10 copies of this right away, please.
- コピーを至急10部お願いします - I need 10 copies of this ASAP, please.
...
**Types of documents:**
- 社内資料 - shanai shiryō - internal documents
- 資料作成 - shiryō sakusei - preparing documents
- 配布資料 - haifu shiryō - documents to pass out to participants
- 手持ち資料 - temochi shiryō - prepared documents (to be used by a speaker and not distributed)
- 添付資料 - tenpu shiryō - attached documents
...
- **直帰 (chokki)** - Going home directly from a client visit without returning to the office
- **直行 (chokkō)** - Going directly to a client from home without coming to the office first
...
**Examples:**
- 資料をまとめているところです。 - I'm in the middle of compiling documents.
- 今、会議をしているところです。 - We're in the middle of a meeting right now.
...
**Politeness levels:**
- ちょっと手伝って (casual, direct)
- ちょっと手伝ってくれない (casual request)
- ちょっと手伝ってくれないか (casual request with か)
- ちょっと手伝ってくれないかな (gentle, soft request)
- 手伝っていただけませんか (formal request)
...
**Examples:**
- 貼っておいて - Put it up (and leave it there)
- 準備しておきます - I'll prepare it (in advance)
- 読んでおいてください - Please read it (beforehand)
...
**Examples:**
- 確認させてください - Please let me confirm
...
### Humble Forms (謙譲語)
- 行く (iku) → 参る (mairu) → 「ただいま参ります」

### Respectful Forms (尊敬語)
- いる (iru) → いらっしゃる (irassharu)

### Polite conversation structure
- Superior to subordinate: casual forms with ね, よ endings
- Subordinate to superior: です/ます forms
...
**Readings:**
- かく (kaku) - on-yomi
- たしか (tashika) - kun-yomi

**Compounds:**
- 確認「かくにん」- kakunin - confirmation
- 確定「かくてい」- kakutei - finalize
