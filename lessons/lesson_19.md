# Lesson 19: お時間を頂いてしまい、申し訳ありません (Ojikan o Itadaite Shimai, Mōshiwake Arimasen)
...
🎧 **Audio:**  
[Listen to this lesson](../mp3/skit19.mp3)
...
> **Explanation:**  
> This is a sophisticated apology that acknowledges you've taken up the customer's valuable time:
> 1.「お時間を」- "your time" (with honorific お)
> 2.「頂いて」- "received" (humble form of もらって)
> 3.「しまい」- regrettable action marker (shows remorse)
> 4.「申し訳ありません」- "I apologize" (formal apology)
> 
...
**Usage examples:**
- デザート盛り合わせ - Dessert platter
- お刺身盛り合わせ - Sashimi platter
- 前菜盛り合わせ - Appetizer platter
- フルーツ盛り合わせ - Fruit platter
...
**Usage examples:**
- （電話で）あいにく山田は今席におりませんが…。  
  (On the phone) Unfortunately, Yamada is away from his desk right now.
- （会う日を決める）申し訳ありませんが、その日はあいにく先約がありまして。他の日はいかがでしょうか。  
  (When making plans) I'm sorry, but unfortunately I have a prior commitment on that day. Are you available another day?
...
**Usage examples:**
- 在庫を確認して参りますので、今しばらくお待ちください。  
  I'll check to see if we have that in stock, so please wait just a little longer.
- ただいま中村は接客中でございます。今しばらくお待ちいただいてもよろしいでしょうか。  
  Nakamura is speaking with a client right now. Could you please wait just a moment?
...
- Making observations: "The food isn't here yet"
- Sarcastic comments: "Must be nice to be busy"
- Questions implying criticism: "Are you understaffed?"
...
- Bow when apologizing
- Use formal, humble language
- Take responsibility even for things beyond your control

### Managing Expectations Without Over-Promising

Important principles:
- Don't say「大丈夫です」(It'll be okay) unless 100% certain
- Use「今しばらく」instead of specific time frames
- Explain the situation without making excuses
...
**Formation:**
[Verb て-form] + しまい + (apology/explanation)

**Examples:**
- お時間を頂いてしまい - (I regret that) I've taken your time
- 忘れてしまい - (I regret that) I forgot
- 壊してしまい - (I regret that) I broke it
...
**Examples:**
- 注文は入っているのですが - Your order is in, but...
- やりたいのですが - I want to do it, but...
- 知っているのですが - I know, but...
...
**Examples:**
- そういえば、彼も来てないね - Now that you mention it, he hasn't come either
- そういえば、明日は会議だ - Come to think of it, there's a meeting tomorrow
...
**Examples:**
- 注文していましたっけ - Did I order it? (casual confirmation)
- 何時でしたっけ - What time was it again?
- どこでしたっけ - Where was it again?
...
**Standard → Humble:**
- 行きます → 参ります (mairimasu) - to go
- 来ます → 参ります (mairimasu) - to come
- います → おります (orimasu) - to be
- もらいます → 頂きます (itadakimasu) - to receive
- 待つ → お待ちする - to wait (honorific for customer)

### Very polite apologies (escalating):
- すみません - Sorry
- 申し訳ありません - I apologize
- 申し訳ございません - I sincerely apologize  
- 大変申し訳ございません - I deeply apologize
...
- 選別「せんべつ」- senbetsu - selection, sorting
