...
🎧 **Audio:** [Listen to this lesson](../mp3/skit23.mp3)
...
> The phrase「仕事はどうなりました？」is often used to check on the status of a job. In this case, the「か」 of「～はどうなりましたか」is omitted.
> You can use a number of terms in the place of「EJの仕事」, such as 「例の件」or「あのプロジェクト」.
...
Example: この製品は受注から納品まで２週間かかる。(This product has a two-week lead time between order and delivery.)  
