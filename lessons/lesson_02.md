# Lesson #2: すみませんが、もう一度言っていただけますか (Sumimasen ga, moo ichido itte itadakemasu ka)
...
🎧 **Audio:**  
[Listen to this lesson](../mp3/skit02.mp3)
...
**Common examples:**
- スマホ (sumaho) ← スマートフォン (smartphone)
- プレゼン (purezen) ← プレゼンテーション (presentation)
- メンテ (mente) ← メンテナンス (maintenance)
- インフラ (infura) ← インフラストラクチャー (infrastructure)

**Japanese + English hybrids:**
- 誰マター (dare-mataa) - who + matter = who's in charge?
...
- 「どのような意味でしょうか」(What does that mean?)
...
**Examples:**
- 開店が来月になったそうです (I heard the opening was pushed to next month)
- 明日は雨だそうです (I heard it will rain tomorrow)
- 田中さんは休むそうです (I heard Tanaka-san will be absent)
...
**Examples:**
- もう一度言っていただけますか (Would you please repeat that?)
- 教えていただけますか (Would you please tell me?)
- 手伝っていただけますか (Would you please help me?)
...
**Examples:**
- 言っておく (I'll tell them - in advance)
- 準備しておく (I'll prepare it - in advance)
- 調べておく (I'll check it - in advance)
...
When asking for clarification, repeat the word or phrase you didn't understand:
「『誰マター』とはどのような意味でしょうか」

This helps the other person know:
- What you did hear correctly
- What specific part you need explained
- That you're paying attention

### Checking Single Syllables

When confirming names or unclear syllables, use the Japanese syllabary system:
- 「あいうえお、の『い』ですか」(Is it "i" from a-i-u-e-o?)
- 「はひふへほの『ひ』ですか」(Is it "hi" from ha-hi-fu-he-ho?)
