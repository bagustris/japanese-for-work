# Lesson #35: かわいいと言いますと (Kawaii to iimasu to)
...
- It gives the client confidence that their needs are understood
...
**Examples:**
- 早めと言いますと、いつごろでしょうか。  
  (When you say "early," about when do you mean?)
  
- 大きいと言いますと、どのくらいのサイズでしょうか。  
  (When you say "big," about what size do you mean?)

- 難しいと言いますと、どういった点が難しいのでしょうか。  
  (When you say "difficult," in what ways is it difficult?)
...
- 会議の資料やペンなどを準備してください。  
  (Please prepare the meeting documents, pens, and so on.)
...
- 条件に合う物件を探しています。  
  (I'm looking for a property that meets the conditions.)
...
**Examples:**
- やはり工事を中止することになりました。  
  (The construction has been canceled after all.)
  
- 天気予報の通り、やっぱり今日は一日中雨が降っていた。  
  (Just like the weather report said, it ended up raining all day.)
