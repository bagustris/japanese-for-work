# Lesson #28: 念のため確認させてください (Nen no tame kakunin sasete kudasai)
...
消毒液についてですが、在庫がなくなりそうな場合は、必ず２日前までに総務に連絡してください。  
...
> The phrase「入って２週間」means「会社に入ってから、２週間が経った」(It's been two weeks since he has joined.). The word「まだ」shows that the speaker thinks this is a comparatively short amount of time. 「よね」is used to confirm.
...
> The word 朝礼 refers to morning group meetings held at school or in the workplace at the beginning of the day. In the workplace, people share information and relay messages at these meetings.
> The phrase「先ほどの朝礼の話、分かりましたか」omits 「が」after 「話」. The phrase「先ほど」means the same thing as 少し前. It's a fairly polite phrase, and it's often used in the business world.
...
はい。消毒液の在庫がなくなりそうなときは、２日前までに総務に連絡します。  
...
- Monitor junior colleagues' understanding
- Check in privately rather than publicly
- Create a safe environment for questions
- Report back to superiors about training progress
...
**Examples:**
- 会議についてですが、明日の10時からです。  
  (About the meeting, it's tomorrow at 10.)
  
- 新しいプロジェクトについてですが、来月から始まります。  
  (Regarding the new project, it starts next month.)
...
- 念のため、メールで送っておきます。  
  (Just in case, I'll send it by email too.)
...
- Daily schedules are coordinated
- Team unity is reinforced
...
- でいらっしゃいます (de irasshaimasu) - Respectful
- でございます (de gozaimasu) - Very polite/humble
