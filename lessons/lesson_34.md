# Lesson 34: Asking for instant guidance
...
> Examples:  
> - 「社長、すみません。」(Excuse me, President.)  
> - 「課長、ご相談したいことがあります。」(Section Leader, I need to ask you something.)
...
- 「搬入する時間」→「搬入時間」(delivery time)
- 「搬入する場所」→「搬入場所」(delivery location)
- 「資材を搬入する」→「資材搬入」(materials for delivery)
- 「搬入についての計画」→「搬入計画」(delivery plan)
...
**Examples:**
- 申し訳ありません。いただいたメールを見落としておりました。  
  *Mooshiwake arimasen. Itadaita meeru o miotoshite orimashita.*  
  I'm very sorry. I overlooked your email.

- 誤字を見落とさないように、複数の人で資料を確認した。  
  *Goji o miotosanai yooni, fukusuu no hito de shiryoo o kakunin-shita.*  
  To prevent any typos, multiple people checked over the documents.
...
- 「会議中」- in the middle of a meeting
- 「外出中」- out of the home or office
- 「食事中」- in the middle of a meal

If you need to speak up when someone is in the middle of something, use:
- 「取り込み中に悪いんだけど…」(to equals/subordinates)
- 「お取り込み中に申し訳ありませんが…」(to superiors)

**Examples:**
- （受付で）申し訳ありません。社長は今取り込み中でして…。  
  *(At reception)* I'm sorry. The president is in the middle of something right now.

- （部下に）取り込み中に悪いんだけど、後で席に来てくれる？  
  *(To a subordinate)* Sorry to interrupt, but can you come by my desk later?
