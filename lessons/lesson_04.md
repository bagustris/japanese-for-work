...
> **Explanation:**  
> 「それでは」is a phrase that responds to the previous speaker's words, and precedes a reaction. In this case, the current speaker is responding to「お願いします」. This phrase is also used before making an explanation.  
>   
...
> To predict the future, use:「１年間に16万人以上の観光客が見込まれます」(It's expected that 160,000 tourists will visit here yearly).
...
**Examples:**
- ヤンゴンから飛行機で約１時間です (About 1 hour from Yangon by plane)
...
1. 見て (Look - casual)
2. 見てください (Please look - polite)
3. ご覧ください (Please look - very polite/respectful)

### Different Levels of "Explain"

From casual to formal:
1. 説明する (Explain - casual)
2. 説明します (I'll explain - polite)
3. ご説明します (I'll explain - very polite)
4. ご説明いたします (I'll explain - extremely polite/humble)
...
1. まず、行きかたについてご説明します。(First, I'll explain how to get there.)
2. 次に、見どころについてご説明します。(Next, I'll explain the highlights.)
3. 最後に、料金についてご説明します。(Finally, I'll explain about the fees.)
