# Lesson #38: 私がやっておきますね (Watashi ga yatte okimasu ne)
...
🎧 **Audio:**  
[Listen to this lesson](../mp3/skit38.mp3)
...
- Working while sick is admirable but not always wise
- The person's health is more important than immediate work needs
- You have confidence they usually work hard (not calling them lazy)
...
**Examples:**
- 会議の前に資料を読んでおきます。  
  (I'll read the materials before the meeting.)
  
- 明日のために準備しておいてください。  
  (Please prepare for tomorrow in advance.)
  
- 連絡しておきました。  
  (I've already contacted them / taken care of contacting them.)
...
**Examples:**
- 部長に任せましょう。  
  (Let's leave it to the department manager.)
  
- 子どもに任せてみます。  
  (I'll try letting my child handle it.)
...
**Examples:**
- 日本語なら教えられます。  
  (If it's Japanese, I can teach it.)
  
- 簡単な作業なら手伝えます。  
  (If it's simple work, I can help.)
  
- その件なら知っています。  
  (If it's about that matter, I know about it.)
...
**Related expressions:**
- 顔色がいい (looks healthy)
- 顔色が青い (looks pale/ashen)
- 顔色を伺う (to read someone's mood/expression)

### 体調がすぐれない (taichoo ga sugurenai)

This is a formal, indirect way to say someone is not feeling well. It's more polite than:
- 具合が悪い (doesn't feel well - casual)
- 気分が悪い (feels sick/nauseated)
- 調子が悪い (not in good condition)
