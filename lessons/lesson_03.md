# Lesson #3: 私のおすすめは、墨田区の水族館です (Watashi no osusume wa, Sumida-ku no suizokukan desu)
...
**Examples:**
- 私のおすすめは、墨田区の水族館です (My recommendation is Sumida Aquarium)
- この製品の特長は安いことです (This product's advantage is that it's cheap)
- 今日の予定は会議です (Today's plan is a meeting)

**Alternative with が for emphasis:**
- 墨田区の水族館が私のおすすめです (Sumida Aquarium is my recommendation)
...
**Examples:**
- 一つ目の理由 (the first reason)
- 二つ目の理由 (the second reason)
- 三つ目の理由 (the third reason)
...
**Examples:**
- 水族館だったら、どこがいいかな (As for aquariums, which is good?)
- ラーメンだったら、あの店がいいですよ (For ramen, that shop is good)
- 旅行だったら、京都がいいと思います (For travel, I think Kyoto is good)
...
- 君は確か、水族館に詳しかったよね (You're knowledgeable about aquariums, right?)
- 確か明日は休みだったよね (Tomorrow is a holiday, right?)
- 確か3時に会議だったよね (The meeting is at 3, right?)
...
- はい、よく行きますが。(Yes, I go often, but... [why do you ask?])
- そうなんですが。(That's true, but... [what about it?])
...
**Pattern:**
- 「理由は二つあります。一つ目の理由は～」(I have two reasons. The first is ~.)
- 「二つ目の理由は～」(The second is ~.)
